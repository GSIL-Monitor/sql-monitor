 ...
 *
 */
public class TotalSQLInTransactionPerMinuteOpsServiceImpl implements ConcreteOpsSchemaProtoService {
    private static final Logger logger = LoggerFactory.getLogger(TotalSQLInTransactionPerMinuteOpsServiceImpl.class);
    ...
    public OpsProto build(String strTimestamp, TransactionPerformanceProduct performance) {
        ...
        e = new BasicNameValuePair("val", String.valueOf(performance.getTotalSQL()));
        httpParams.add(e);
