 ...
 */
@Service
public class TableTxMetric extends AbstractMetric {
    private static final Logger logger = LoggerFactory.getLogger(TableTxMetric.class);
    ...
    @Resource(name = "transactionValue")
    private Value value;
