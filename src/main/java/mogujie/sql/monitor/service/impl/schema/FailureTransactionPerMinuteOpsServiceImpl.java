 ...
 *
 */
public class FailureTransactionPerMinuteOpsServiceImpl implements ConcreteOpsSchemaProtoService {
    private static final Logger logger = LoggerFactory.getLogger(FailureTransactionPerMinuteOpsServiceImpl.class);
    ...
    public OpsProto build(String strTimestamp, TransactionPerformanceProduct performance) {
        ...
        e = new BasicNameValuePair("val", String.valueOf(performance.getFailure()));
        httpParams.add(e);
